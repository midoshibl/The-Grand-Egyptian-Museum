import mainimg from "../../assets/images/mainFoyer.png"
...
function MainFoyer() { // غير الاسم لاسم القاعة (مثلاً RamsesHall)
        ...
        <section className="py-[105px]">
            <div className="p-3 bg-white text-[20px] font-medium text-[#4B5563] shadow w-full fixed top-[105px] z-40">
                <div className="container flex gap-2">
                    ...
                    <span className="text-[#CD7F32]">البهو العظيم</span>
                </div>
            </div>
        </section>
