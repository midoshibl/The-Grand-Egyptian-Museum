import logo_nav from "../../assets/images/logo2.jpg";
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pb-8 text-center sm:text-right">
        ...
        <div className="space-y-3">
          ...
          <ul className="text-[#D1D5DB] space-y-3 text-sm">
            ...
            <li >
              <a href="https://maps.app.goo.gl/U7CJXKUhRBndRDEc7" className="flex items-start justify-center sm:justify-start gap-2">
        ...
        <div className="space-y-3 flex flex-col items-center sm:items-start">
          ...
          <ul className="flex flex-wrap justify-center sm:justify-start gap-3 pt-1">
            <li className="bg-[#D4AF37] rounded-full p-2.5 hover:scale-110 hover:bg-amber-500 transition-all shadow-md">
              <a href="https://www.facebook.com/GrandEgyptianMuseum" target="_blank" rel="noreferrer" className="flex items-center justify-center"><FaFacebook size={22} color="#1877F2" /></a>
            </li>
            <li className="bg-[#D4AF37] rounded-full p-2.5 hover:scale-110 hover:bg-amber-500 transition-all shadow-md">
             <a href="https://www.instagram.com/grandegyptianmuseum" target="_blank" rel="noreferrer" className="flex items-center justify-center"><FaInstagram size={22} className="text-purple-700" /></a>
            </li>
            {/* <li className="bg-[#D4AF37] rounded-full p-2.5 hover:scale-110 hover:bg-amber-500 transition-all shadow-md"> */}
            ...
            {/* </li> */}
            <li className="bg-[#D4AF37] rounded-full p-2.5 hover:scale-110 hover:bg-amber-500 transition-all shadow-md">
              <a href="https://www.youtube.com/@GrandEgyptianMuseum" target="_blank" rel="noreferrer" className="flex items-center justify-center"><FaYoutube size={22} color="#FF0000" /></a>
            </li>
          </ul>
        </div>
